...
export const MONSTER_DEFS: Record<MonsterType, MonsterDef> = {
  ...
  war_pharaoh:  { type: 'war_pharaoh',  sprite: 'eyeball',  size: { w: 56, h: 56 }, hp: 620, speed: 30,  aggroRange: 320, attackRange: 64, contactDmg: 12, score: 170, boss: true, rangedCooldown: 2.5, res: { fire: 30, physical: 20 }, tint: [1, 0.82, 0.4], bossSkill: 'ring' },
  frost_lich:   { type: 'frost_lich',   sprite: 'ghost',    size: { w: 56, h: 56 }, hp: 700, speed: 36,  aggroRange: 340, attackRange: 56, contactDmg: 15, score: 190, boss: true, rangedCooldown: 2.0, res: { fire: 30, physical: 40, ice: 45 }, tint: [0.5, 0.85, 1], bossSkill: 'summon' },
  void_overlord:{ type: 'void_overlord', sprite: 'pumpking', size: { w: 72, h: 72 }, hp: 1300, speed: 26, aggroRange: 360, attackRange: 88, contactDmg: 20, score: 270, boss: true, rangedCooldown: 2.4, res: { fire: 50, physical: 45, shadow: 30 }, tint: [0.75, 0.4, 1], bossSkill: 'charge' },
};
